public abstract class KamarKost {
    ...
    public abstract int getKapasitasPenyewa();
    ...
    public int hitungTotalBiaya(int bulan) {
        return hargaPerBulan * bulan;
    }

    public int hitungTotalBiaya(int bulan, double diskon) {
        int total = hargaPerBulan * bulan;
        return (int) (total * (1 - diskon / 100));
    }
    ...
    public void tampilkanInfoDasar() {
        ...
        System.out.println("Kapasitas     : " + getKapasitasPenyewa() + " orang");
